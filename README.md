...
DX（デジタルトランスフォーメーション）推進において、データの利活用はすべての組織が取り組まなくてはならない課題です。しかしそれ以前に、そもそも利活用できるデータが少ない、データがあったとしても使いやすい形に整える作業（データクレンジング）に多大なる手間がかかっているという組織も多いのではないでしょうか。
...
世の中に使いやすいデータを増やすために、手間のかかるデータクレンジング作業を減らすためにも、皆さまの職場や学校などでご自由にご利用ください。
